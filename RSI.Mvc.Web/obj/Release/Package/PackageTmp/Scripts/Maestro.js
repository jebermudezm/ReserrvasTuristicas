...
function ajaxPostCrearMaestro(url) {
    $.ajax({
        type: 'POST',
        url: url,
        data: $("#crearMaestroForm").serialize(),
        dataType: 'json',
        cache: false,
        success: function (result, status, xhr) {
...
function ajaxPostHabilitarMaestro(url) {
    $.ajax({
        type: 'POST',
        url: url,
        data: {
...
function ajaxPostEditarMaestro(url) {
    $.ajax({
        type: 'POST',
        url: url,
        data: $("#editarMaestroForm").serialize(),
        dataType: 'json',
        cache: false,
        success: function (result, status, xhr) {
            if (typeof result === 'undefined') {
...
function ajaxPostEliminarMaestro(url) {
    $.ajax({
        type: 'POST',
        url: url,
        data: $("#EliminarMaestroForm").serialize(),
        dataType: 'json',
        cache: false,
        success: function (result, status, xhr) {
            if (typeof result === 'undefined') {
